...
/** @defgroup Light
  ...
  * @{
  */
//RD_EDIT: C4LED chon loai tbi
#define	DOWNLIGHT_AT16			1
#define	DOWNLIGHT_AT14			2
#define	DOWNLIGHT_AT18_7W		3
#define	DOWNLIGHT_AT18_12W		4
#define	DOWNLIGHT_AT18_12W_FW	5
#define	DOWNLIGHT_AT18_9W		6
#define	DOWNLIGHT_AT19			7
#define	PANEL_PT04				8
#define	PANEL_PT07				9
#define	OP_TRAN					10
#define	TRACKLIGHT				11
#define	THA_TRAN				12
#define	LED_DAY_CT				13
#define DOWNLIGHT_AT20			14

#define DOWNLIGHT_COB_AT39			15
#define DOWNLIGHT_COB_AT40			16
#define DOWNLIGHT_COB_AT41			17

#define TIME_DIM0			3		//RD_EDIT: Thoi gian reset
#define TIME_DIM20			5
...
#define LIGHT_TYPE				DOWNLIGHT_COB_AT41

#if((LIGHT_TYPE == PANEL_PT07) || (LIGHT_TYPE == OP_TRAN)\
	|| (LIGHT_TYPE == DOWNLIGHT_COB_AT39) || (LIGHT_TYPE == DOWNLIGHT_COB_AT40) || (LIGHT_TYPE == DOWNLIGHT_COB_AT41))
#define TIME_RESET				TIME_DIM20
#define SELECT_DIM				RD_DIM_20

#elif((LIGHT_TYPE == LED_DAY_CT))
#define TIME_RESET				TIME_DIM0
...
//RD_EDIT: C4LED convert CCT
#define CTL_TEMP_MAX			(0x1964)	// 6500

#if((LIGHT_TYPE == DOWNLIGHT_AT16) || (LIGHT_TYPE == PANEL_PT07) || (LIGHT_TYPE == OP_TRAN) || (LIGHT_TYPE == LED_DAY_CT) || (LIGHT_TYPE == DOWNLIGHT_AT20))
	#define CTL_TEMP_MIN (0x0BB8)	// 3000
	#define CTL_TEMP_MIDDLE (0x1194)
#elif(LIGHT_TYPE == PANEL_PT04)
	#define CTL_TEMP_MIN (0x0FA0)	// 4000
	#define CTL_TEMP_MIDDLE (0x1482)
#elif((LIGHT_TYPE == DOWNLIGHT_AT14) || (LIGHT_TYPE == DOWNLIGHT_AT18_7W) || (LIGHT_TYPE == DOWNLIGHT_AT18_12W) || (LIGHT_TYPE == DOWNLIGHT_AT18_12W_FW) \
		|| (LIGHT_TYPE == DOWNLIGHT_AT18_9W) || (LIGHT_TYPE == DOWNLIGHT_AT19) || (LIGHT_TYPE == TRACKLIGHT) || (LIGHT_TYPE == THA_TRAN)\
		|| (LIGHT_TYPE == DOWNLIGHT_COB_AT39) || (LIGHT_TYPE == DOWNLIGHT_COB_AT40) || (LIGHT_TYPE == DOWNLIGHT_COB_AT41))
	#define CTL_TEMP_MIN (0x0A8C)	// 2700
	#define CTL_TEMP_MIDDLE (0x11F8)
#endif
//end
