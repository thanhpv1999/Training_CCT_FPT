...
//RD_EDIT C4LED broadcast
	tbl_scanRsp.rsv_user[0] = 0x0A;
	tbl_scanRsp.rsv_user[1] = 0xFF;
	tbl_scanRsp.rsv_user[2] = 0x00;
	tbl_scanRsp.rsv_user[3] = 0x00;
	tbl_scanRsp.rsv_user[4] = 0x01;

	#if((LIGHT_TYPE == DOWNLIGHT_COB_AT39) || (LIGHT_TYPE == DOWNLIGHT_COB_AT40) || (LIGHT_TYPE == DOWNLIGHT_COB_AT41))
		tbl_scanRsp.rsv_user[5] = 0x28;
		tbl_scanRsp.rsv_user[6] = 0x10;
		tbl_scanRsp.rsv_user[7] = 0x08;
		tbl_scanRsp.rsv_user[8] = 0x04;
		tbl_scanRsp.rsv_user[9] = 0x00;
	#else
		tbl_scanRsp.rsv_user[5] = 0x02;
		tbl_scanRsp.rsv_user[7] = 0x01;
		tbl_scanRsp.rsv_user[8] = 0x00;
		tbl_scanRsp.rsv_user[10]= 0x00;
	#endif

	#if(LIGHT_TYPE == DOWNLIGHT_AT16)
		tbl_scanRsp.rsv_user[6] = 0x05;
		tbl_scanRsp.rsv_user[9] = 0x01;
	#elif(LIGHT_TYPE == DOWNLIGHT_AT14)
		tbl_scanRsp.rsv_user[6] = 0x05;
		tbl_scanRsp.rsv_user[9] = 0x02;
	#elif(LIGHT_TYPE == DOWNLIGHT_AT18_7W)
		tbl_scanRsp.rsv_user[6] = 0x05;
		tbl_scanRsp.rsv_user[9] = 0x03;
	#elif(LIGHT_TYPE == DOWNLIGHT_AT18_12W)
		tbl_scanRsp.rsv_user[6] = 0x05;
		tbl_scanRsp.rsv_user[9] = 0x04;
	#elif(LIGHT_TYPE == DOWNLIGHT_AT18_12W_FW)
		tbl_scanRsp.rsv_user[6] = 0x05;
		tbl_scanRsp.rsv_user[9] = 0x05;
	#elif(LIGHT_TYPE == DOWNLIGHT_AT18_9W)
		tbl_scanRsp.rsv_user[6] = 0x05;
		tbl_scanRsp.rsv_user[9] = 0x06;
	#elif(LIGHT_TYPE == DOWNLIGHT_AT19)
		tbl_scanRsp.rsv_user[6] = 0x05;
		tbl_scanRsp.rsv_user[9] = 0x07;
	#elif(LIGHT_TYPE == PANEL_PT04)
		tbl_scanRsp.rsv_user[6] = 0x06;
		tbl_scanRsp.rsv_user[9] = 0x01;
	#elif(LIGHT_TYPE == PANEL_PT07)
		tbl_scanRsp.rsv_user[6] = 0x06;
		tbl_scanRsp.rsv_user[9] = 0x02;
	#elif(LIGHT_TYPE == OP_TRAN)
		tbl_scanRsp.rsv_user[6] = 0x07;
		tbl_scanRsp.rsv_user[9] = 0x01;
	#elif(LIGHT_TYPE == TRACKLIGHT)
		tbl_scanRsp.rsv_user[6] = 0x03;
		tbl_scanRsp.rsv_user[9] = 0x01;
	#elif(LIGHT_TYPE == THA_TRAN)
		tbl_scanRsp.rsv_user[6] = 0x08;
		tbl_scanRsp.rsv_user[9] = 0x01;
	#elif(LIGHT_TYPE == LED_DAY_CT)
		tbl_scanRsp.rsv_user[6] = 0x04;
		tbl_scanRsp.rsv_user[9] = 0x01;
	#elif(LIGHT_TYPE == DOWNLIGHT_AT20)
		tbl_scanRsp.rsv_user[6] = 0x05;
		tbl_scanRsp.rsv_user[9] = 0x09;

	#elif(LIGHT_TYPE == DOWNLIGHT_COB_AT39)
		tbl_scanRsp.rsv_user[10] = 0xa2;
	#elif(LIGHT_TYPE == DOWNLIGHT_COB_AT40)
		tbl_scanRsp.rsv_user[10] = 0xa3;
	#elif(LIGHT_TYPE == DOWNLIGHT_COB_AT41)
		tbl_scanRsp.rsv_user[10] = 0xa4;
	#endif
//end
